...
\question $(2x)^3 = {\color{blue} }$
\question $(3y)^4 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(5a)^2 = {\color{blue} }$
\question $(4m)^3 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(xy)^5 = {\color{blue} }$
\question $(2b)^5 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(3c)^3 = {\color{blue} }$
\question $(6p)^2 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(ab)^7 = {\color{blue} }$
\question $(7n)^2 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(10z)^3 = {\color{blue} }$
\question $(xyz)^2 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(2w)^4 = {\color{blue} }$
\question $(5r)^3 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(abc)^3 = {\color{blue} }$
\question $(3s)^5 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(8t)^2 = {\color{blue} }$
\question $(mn)^4 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(4q)^4 = {\color{blue} }$
\question $(pqr)^2 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(9v)^2 = {\color{blue} }$
\question $(xy^2)^3 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(2a^3)^4 = {\color{blue} }$
\question $(3m^2)^3 = {\color{blue} }$
\end{multicols}
...
\question $\left(\dfrac{x}{y}\right)^3 = {\color{blue} }$
\question $\left(\dfrac{2}{3}\right)^4 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{a}{b}\right)^5 = {\color{blue} }$
\question $\left(\dfrac{5}{2}\right)^3 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{m}{n}\right)^2 = {\color{blue} }$
\question $\left(\dfrac{3}{4}\right)^3 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{p}{q}\right)^4 = {\color{blue} }$
\question $\left(\dfrac{7}{2}\right)^2 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{c}{d}\right)^6 = {\color{blue} }$
\question $\left(\dfrac{1}{2}\right)^5 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{r}{s}\right)^3 = {\color{blue} }$
\question $\left(\dfrac{4}{5}\right)^3 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{w}{z}\right)^4 = {\color{blue} }$
\question $\left(\dfrac{2}{7}\right)^3 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{x^2}{y}\right)^3 = {\color{blue} }$
\question $\left(\dfrac{3a}{b}\right)^2 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{m^3}{n^2}\right)^2 = {\color{blue} }$
\question $\left(\dfrac{5x}{2y}\right)^2 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{2p}{3q}\right)^3 = {\color{blue} }$
\question $\left(\dfrac{a^4}{b^2}\right)^2 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{3}{x}\right)^4 = {\color{blue} }$
\question $\left(\dfrac{c^2}{d^3}\right)^3 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{4r}{5s}\right)^2 = {\color{blue} }$
\question $\left(\dfrac{w^5}{z^2}\right)^2 = {\color{blue} }$
\end{multicols}
\end{questions}
