...
\question $(x^2)^3 = {\color{blue} }$
\question $(3^4)^2 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(y^5)^2 = {\color{blue} }$
\question $(2^3)^4 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(a^7)^3 = {\color{blue} }$
\question $(5^2)^5 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(m^4)^4 = {\color{blue} }$
\question $(4^3)^3 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(b^6)^2 = {\color{blue} }$
\question $(7^2)^4 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(c^3)^5 = {\color{blue} }$
\question $(6^4)^2 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(p^8)^2 = {\color{blue} }$
\question $(10^2)^3 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(n^5)^4 = {\color{blue} }$
\question $(2^5)^2 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(z^9)^2 = {\color{blue} }$
\question $(3^6)^2 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(w^4)^5 = {\color{blue} }$
\question $(8^3)^2 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(r^{10})^3 = {\color{blue} }$
\question $(9^2)^3 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(s^7)^3 = {\color{blue} }$
\question $(11^2)^4 = {\color{blue} }$
\end{multicols}
