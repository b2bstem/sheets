...
\begin{questions}
    \begin{multicols}{2}
\question $\dfrac{x^8}{x^3} = {\color{blue} }$
\question $\dfrac{5^7}{5^2} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{y^{10}}{y^4} = {\color{blue} }$
\question $\dfrac{3^9}{3^5} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{a^{15}}{a^6} = {\color{blue} }$
\question $\dfrac{7^8}{7^3} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
