...
\question $10^2 \cdot 10^5  = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
    \question $5^3 \cdot 5^4  = {\color{blue} }$
\question $c^9 \cdot c  = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $x^2 \cdot x^3 \cdot x^4  = {\color{blue} }$
\question $2^1 \cdot 2^2 \cdot 2^3  = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $4^2 \cdot 4 \cdot 4^3  = {\color{blue} }$
\question $n^4 \cdot n^4  = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
    \question $p^5 \cdot p^3 \cdot p  = {\color{blue} }$
\question $7^3 \cdot 7^2  = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $z^{10} \cdot z^5  = {\color{blue} }$
\question $6^4 \cdot 6^2  = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}

\question $8^2 \cdot 8^3  = {\color{blue} }$
\question $r^{12} \cdot r^8  = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
    \question $w^3 \cdot w^7  = {\color{blue} }$
\question $3^6 \cdot 3  = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $s^5 \cdot s^5 \cdot s^5 = {\color{blue} }$
\question $9^2 \cdot 9^4  = {\color{blue} }$
    \end{multicols}
\end{questions}
