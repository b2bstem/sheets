...
\question $2^{-3} = {\color{blue} }$
\question $x^{-5} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $5^{-2} = {\color{blue} }$
\question $y^{-4} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $3^{-4} = {\color{blue} }$
\question $a^{-7} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $10^{-3} = {\color{blue} }$
\question $m^{-6} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $4^{-2} = {\color{blue} }$
\question $b^{-3} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $6^{-2} = {\color{blue} }$
\question $c^{-8} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $7^{-3} = {\color{blue} }$
\question $p^{-5} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{1}{x^{-3}} = {\color{blue} }$
\question $\dfrac{1}{2^{-4}} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{1}{y^{-6}} = {\color{blue} }$
\question $\dfrac{1}{5^{-2}} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $x^{-2} \cdot x^5 = {\color{blue} }$
\question $y^7 \cdot y^{-3} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{a^5}{a^{-2}} = {\color{blue} }$
\question $\dfrac{m^{-4}}{m^2} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(n^{-3})^2 = {\color{blue} }$
\question $(p^2)^{-3} = {\color{blue} }$
\end{multicols}
\end{questions}
