...
\subsection*{Product Rule: $a^m \cdot a^n = a^{m+n}; \quad a^m\cdot a^n\cdot a^w\cdots a^r=a^{m+n+w+\cdots r}$}

\begin{questions}
    \begin{multicols}{2}
\question $x^3 \cdot x^5  = {\color{blue} x^{3+5}=x^8}$
\question $2^4 \cdot 2^3  = {\color{blue} 2^{4+3}=2^7=128}$
    \end{multicols}
    \begin{multicols}{2}
\question $y^7 \cdot y^2  = {\color{blue} y^{7+2}=y^9}$
\question $3^2 \cdot 3  = {\color{blue} 3^{2+1}=3^3=27}$
    \end{multicols}
    \begin{multicols}{2}
\question $a^4 \cdot a  = {\color{blue} a^{4+1}=a^5}$
\question $m^6 \cdot m^3  = {\color{blue} m^{6+3}=m^9}$
\end{multicols}
\begin{multicols}{2}

\question $b^8 \cdot b^2  = {\color{blue} b^{8+2}=b^{10}}$
\question $10^2 \cdot 10^5  = {\color{blue} 10^{2+5}=10^7=10,000,000}$
\end{multicols}
\begin{multicols}{2}
    \question $5^2 \cdot 5^2  = {\color{blue} 5^{2+2}=5^4=625}$
\question $c^9 \cdot c  = {\color{blue} c^{9+1}=c^{10}}$
\end{multicols}
\begin{multicols}{2}
\question $x^2 \cdot x^3 \cdot x^4  = {\color{blue} x^{3+7}=x^7}$
\question $2^1 \cdot 2^2 \cdot 2^3  = {\color{blue} 2^{2+3}=2^5=32}$
\end{multicols}
\begin{multicols}{2}
\question $4^2 \cdot 4 \cdot 4^3  = {\color{blue} 4^{2+1+3}=4^6=4096}$
\question $n^4 \cdot n^4  = {\color{blue} n^{4+4}=n^8}$
\end{multicols}
\begin{multicols}{2}
    \question $p^5 \cdot p^3 \cdot p  = {\color{blue} p^{5+3+1}=p^9}$
\question $7^3 \cdot 7^2  = {\color{blue} 7^{3+2}=7^5=16,807}$
\end{multicols}
\begin{multicols}{2}
\question $z^{10} \cdot z^5  = {\color{blue} z^{10+5}=z^{15}}$
\question $6^2 \cdot 6^3  = {\color{blue} 6^{2+3}=6^5=7776}$
\end{multicols}
\begin{multicols}{2}

\question $8^2 \cdot 8^3  = {\color{blue} 8^{2+3}=8^5=32,768}$
\question $r^{12} \cdot r^8  = {\color{blue} r^{12+8}=r^{20}}$
\end{multicols}
\begin{multicols}{2}
    \question $w^3 \cdot w^7  = {\color{blue} w^{3+7}=w^{11}}$
\question $3^6 \cdot 3  = {\color{blue} 3^{6+1}=3^7=2,187}$
\end{multicols}
\begin{multicols}{2}
\question $s^5 \cdot s^2 \cdot s = {\color{blue} s^{5+2+1}=s^{8}}$
\question $3^2 \cdot 3^3  = {\color{blue} 3^{2+3}=3^5=243}$
    \end{multicols}
\end{questions}
...
\begin{questions}
    \begin{multicols}{2}
\question $\dfrac{x^8}{x^3} = {\color{blue} x^{8-3}=x^5}$
\question $\dfrac{5^5}{5^2} = {\color{blue} }5^{5-2}=5^3=125$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{y^{10}}{y^4} = {\color{blue} y^{10-4}=y^6}$
\question $\dfrac{3^9}{3^5} = {\color{blue} 3^{9-5}=3^4=81}$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{a^{15}}{a^6} = {\color{blue} a^{15-6}=a^9}$
\question $\dfrac{7^4}{7^3} = {\color{blue}  7^{4-3}=7^1=7}$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{m^{12}}{m^7} = {\color{blue} m^{12-7}=m^5}$
\question $\dfrac{2^{10}}{2^4} = {\color{blue} 2^{10-4}=2^6=64}$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{b^{20}}{b^{13}} = {\color{blue} b^{20-13}=b^7}$
\question $\dfrac{6^5}{6^2} = {\color{blue} 6^{5-2}=6^3=216}$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{c^{11}}{c^8} = {\color{blue} c^{11-8}=c^3}$
\question $\dfrac{10^7}{10^3} = {\color{blue} 10^{7-3}=10^4=10,000}$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{p^{18}}{p^9} = {\color{blue} p^{18-9}=p^{9}}$
\question $\dfrac{4^{11}}{4^6} = {\color{blue} 4{11-6}=4^5=1,024}$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{n^{25}}{n^{20}} = {\color{blue} n^{25-20}=n^5}$
\question $\dfrac{8^7}{8^4} = {\color{blue} 8^{7-4}=8^3=512}$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{z^{16}}{z^5} = {\color{blue} z^{16-5}=z^9}$
\question $\dfrac{9^5}{9^3} = {\color{blue} 9^{5-3}=9^2=81}$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{w^{14}}{w^7} = {\color{blue} w^{14-7}=w^7}$
\question $\dfrac{11^{6}}{11^3} = {\color{blue} 11^{6-3}=11^3=1,331}$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{r^{30}}{r^{15}} = {\color{blue} r^{30-15}=r^{15}}$
\question $\dfrac{12^4}{12^2} = {\color{blue} 12^{4-2}=12^2=144}$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{s^{22}}{s^{11}} = {\color{blue} s^{22-11}=s^{11}}$
\question $\dfrac{5^{15}}{5^{10}} = {\color{blue} 5^{15-10}=5^5=3,125}$
\end{multicols}
\end{questions}
...
\question $(x^2)^3 = {\color{blue} x^{2\times 3=x^6}}$
\question $(3^4)^2 = {\color{blue} 3^{4\times 2=3^8=6,561}}$
\end{multicols}
\begin{multicols}{2}
\question $(y^5)^2 = {\color{blue} y^{5\times 2}=y^{10}}$
\question $(2^3)^4 = {\color{blue} 2^{3\times 4}=2^{12}=4,096}$
\end{multicols}
\begin{multicols}{2}
\question $(a^7)^3 = {\color{blue} a^{7\times 3}=7^{21}}$
\question $(5^2)^2 = {\color{blue} 5^{2\times 2}=5^4=625}$
\end{multicols}
\begin{multicols}{2}
\question $(m^4)^4 = {\color{blue} m^{4\times 4}m^{16}}$
\question $(4^3)^2= {\color{blue} 4^{3\times 2}}=4^6=4,096$
\end{multicols}
\begin{multicols}{2}
\question $(b^6)^2 = {\color{blue} b^{6\times 2}=b^{12}}$
\question $(3^2)^3 = {\color{blue} 3^{2\times 3}=3^6=729}$
\end{multicols}
\begin{multicols}{2}
\question $(c^3)^5 = {\color{blue} c^{3\times 5}=c^{15}}$
\question $(6^2)^2 = {\color{blue} 6^{2\times 2}=6^4=1,296}$
\end{multicols}
\begin{multicols}{2}
\question $(p^8)^2 = {\color{blue} p^{8\times 2}=p^{16}}$
\question $(10^2)^3 = {\color{blue} 10^{2\times 3}=10^6=1,000,000}$
\end{multicols}
\begin{multicols}{2}
\question $(n^5)^4 = {\color{blue} n^{5\times 4}=n^{20}}$
\question $(2^5)^2 = {\color{blue} 2^{5\times 2}=2^{10}=1,024}$
\end{multicols}
\begin{multicols}{2}
\question $(z^9)^2 = {\color{blue} z^{9\times 2}=z^{18}}$
\question $(3^3)^2 = {\color{blue} 3{3\times 2}=3^6=729}$
\end{multicols}
\begin{multicols}{2}
\question $(w^4)^5 = {\color{blue} w^{4\times 5}=w^{20}}$
\question $(8^3)^2 = {\color{blue} 8^{3\times 2}=8^6=262,144}$
\end{multicols}
\begin{multicols}{2}
\question $(r^{10})^3 = {\color{blue} r^{10times 3}=r^{30}}$
\question $(9)^3 = {\color{blue} 9^{1\times 3=9^3=729}}$
\end{multicols}
\begin{multicols}{2}
\question $(s^7)^3 = {\color{blue} s^{7\times 3}=s^{21}}$
\question $(11^2)^2 = {\color{blue} 11^{2\times 2}=11^4=14,641}$
\end{multicols}
...
\question $(2x)^3 = {\color{blue} 2^3\, x^3=8\,x^3}$
\question $(3y)^4 = {\color{blue} 3^4\,y^4=81\,y^4}$
\end{multicols}
\begin{multicols}{2}
\question $(5a)^2 = {\color{blue} 5^2\,a^2=25\,a^2}$
\question $(4m)^3 = {\color{blue} 4^3\,m^3=64\,m^3}$
\end{multicols}
\begin{multicols}{2}
\question $(xy)^5 = {\color{blue} x^5\,y^5}$
\question $(2b)^5 = {\color{blue} 2^5\,b^5=32\,b^5}$
\end{multicols}
\begin{multicols}{2}
\question $(3c)^3 = {\color{blue} 3^3\,c^3=27\,c^3}$
\question $(6p)^2 = {\color{blue} 6^2\,p^2=36\,p^2}$
\end{multicols}
\begin{multicols}{2}
\question $(ab)^7 = {\color{blue} a^7\,b^7}$
\question $(7n)^2 = {\color{blue} 7^2\,n^2=49\,n^2}$
\end{multicols}
\begin{multicols}{2}
\question $(10z)^3 = {\color{blue} 10^3\,z^3=1,000\,z^3}$
\question $(xyz)^2 = {\color{blue} x^2\,y^2\,z^2}$
\end{multicols}
\begin{multicols}{2}
\question $(2w)^4 = {\color{blue} 2^4\,w^4=16\,w^4}$
\question $(5r)^3 = {\color{blue} 5^3\,r^3=125\,r^3}$
\end{multicols}
\begin{multicols}{2}
\question $(abc)^3 = {\color{blue} a^3\,b^3\,c^3}$
\question $(3s)^5 = {\color{blue} 3^5\,s^5=243\,s^5}$
\end{multicols}
\begin{multicols}{2}
\question $(8t)^2 = {\color{blue} 8^2\,t^2=64\,t^2}$
\question $(mn)^4 = {\color{blue} m^4\,n^4}$
\end{multicols}
\begin{multicols}{2}
\question $(4q)^4 = {\color{blue} 4^4\,q^4=256\,q^4}$
\question $(pqr)^2 = {\color{blue} p^2\,q^2\,r^2}$
\end{multicols}
\begin{multicols}{2}
\question $(9v)^2 = {\color{blue} 9^2\,v^2=81\,v^2}$
\question $(xy^2)^3 = {\color{blue} x^3\, y^{2\times 3}=x^3\,y^6}$
\end{multicols}
\begin{multicols}{2}
\question $(2a^3)^4 = {\color{blue} 2^4\,a^{3\times 4}=16\,a^{12}}$
\question $(3m^2)^3 = {\color{blue} }3^3\,m^{2\times 3}=27\,m^6$
\end{multicols}
...
\question $\left(\dfrac{x}{y}\right)^3 = {\color{blue} \dfrac{x^3}{y^3}}$
\question $\left(\dfrac{2}{3}\right)^4 = {\color{blue} \dfrac{2^4}{3^4}=\dfrac{16}{81}}$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{a}{b}\right)^5 = {\color{blue} \dfrac{a^5}{b^5}}$
\question $\left(\dfrac{5}{2}\right)^3 = {\color{blue} \dfrac{5^3}{2^3}=\dfrac{125}{8}}$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{m}{n}\right)^2 = {\color{blue} \dfrac{m^2}{n^2}}$
\question $\left(\dfrac{3}{4}\right)^3 = {\color{blue} \dfrac{3^3}{4^3}}=\dfrac{27}{64}$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{p}{q}\right)^4 = {\color{blue} \dfrac{p^4}{q^4}}$
\question $\left(\dfrac{7}{2}\right)^2 = {\color{blue} \dfrac{7^2}{2^2}=\dfrac{49}{4}}$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{c}{d}\right)^6 = {\color{blue} \dfrac{c^6}{d^6}}$
\question $\left(\dfrac{1}{2}\right)^5 = {\color{blue} \dfrac{1^5}{2^5}=\dfrac{1}{32}}$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{r}{s}\right)^3 = {\color{blue} \dfrac{r^3}{s^3}}$
\question $\left(\dfrac{4}{5}\right)^3 = {\color{blue} \dfrac{4^3}{5^3}=\dfrac{64}{125}}$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{w}{z}\right)^4 = {\color{blue} \dfrac{w^4}{z^4}}$
\question $\left(\dfrac{2}{7}\right)^3 = {\color{blue} \dfrac{2^3}{7^3}=\dfrac{8}{343}}$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{x^2}{y}\right)^3 = {\color{blue} \dfrac{x^{2\times 3}}{y^3}=\dfrac{x^6}{y^3}}$
\question $\left(\dfrac{3a}{b}\right)^2 = {\color{blue} \dfrac{3^2\,a^2}{b^2}\dfrac{9\,a^2}{b^@}}$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{m^3}{n^2}\right)^2 = {\color{blue} \dfrac{m^{3\times 2}}{n^{2\times 2}}=\dfrac{m^6}{n^4}}$
\question $\left(\dfrac{5x}{2y}\right)^2 = {\color{blue} \dfrac{5^2\,x^2}{2^2\,y^2}\dfrac{25\,x^2}{4\,y^2}}$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{2p}{3q}\right)^3 = {\color{blue} \dfrac{2^3\,p^3}{3^3\,q^3}=\dfrac{8\,p^3}{27\,q^3q}}$
\question $\left(\dfrac{a^4}{b^2}\right)^2 = {\color{blue} \dfrac{a^{4\times 2}}{b^{2\times 2}}=\dfrac{a^8}{b^4}}$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{3}{x}\right)^4 = {\color{blue} \dfrac{3^4}{x^4}=\dfrac{81}{x^3}}$
\question $\left(\dfrac{c^2}{d^3}\right)^3 = {\color{blue} \dfrac{c^2}{d^3}=\dfrac{c^{2\times 3}}{d^{3\times 3}}=\dfrac{c^6}{d^9}}$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{4r}{5s}\right)^2 = {\color{blue} \dfrac{4^2\,r^2}{5^2\,s^2}=\dfrac{16\,r^2}{25\,s^2}}$
\question $\left(\dfrac{w^5}{z^2}\right)^2 = {\color{blue} \dfrac{w^{5\times 2}}{z^{2\times 2}}=\dfrac{w^{10}}{z^4}}$
\end{multicols}
\end{questions}
...
\question $5^0 = {\color{blue} }$
\question $x^0 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(-3)^0 = {\color{blue} }$
\question $100^0 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(2y)^0 = {\color{blue} }$
\question $7^0 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(abc)^0 = {\color{blue} }$
\question $(-10)^0 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(x^5)^0 = {\color{blue} }$
\question $\left(\dfrac{3}{4}\right)^0 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $1000^0 = {\color{blue} }$
\question $(5a^3b^2)^0 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(-1)^0 = {\color{blue} }$
\question $(xyz)^0 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\left(\dfrac{m}{n}\right)^0 = {\color{blue} }$
\question $99^0 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(2^{10})^0 = {\color{blue} }$
\question $\left(\dfrac{x^2}{y^3}\right)^0 = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $(-7)^0 = {\color{blue} }$
\question $(4pqr)^0 = {\color{blue} }$
\end{multicols}
\end{questions}
...
\question $2^{-3} = {\color{blue} \dfrac{1}{2^3}=\dfrac{1}{8}}$
\question $x^{-5} = {\color{blue} \dfrac{1}{x^5}}$
\end{multicols}
\begin{multicols}{2}
\question $5^{-2} = {\color{blue} \dfrac{1}{5^2}=\dfrac{1}{25}}$
\question $y^{-4} = {\color{blue} \dfrac{1}{y^4}}$
\end{multicols}
\begin{multicols}{2}
\question $3^{-4} = {\color{blue} \dfrac{1}{3^4}=\dfrac{1}{81}}$
\question $a^{-7} = {\color{blue} \dfrac{1}{a^7}}$
\end{multicols}
\begin{multicols}{2}
\question $10^{-3} = {\color{blue} \dfrac{1}{10^3}=\dfrac{1}{1,000}}$
\question $m^{-6} = {\color{blue} =\dfrac{1}{m^6}}$
\end{multicols}
\begin{multicols}{2}
\question $4^{-2} = {\color{blue} \dfrac{1}{4^2}=\dfrac{1}{16}}$
\question $b^{-3} = {\color{blue} \dfrac{1}{b^3}}$
\end{multicols}
\begin{multicols}{2}
\question $6^{-2} = {\color{blue} \dfrac{1}{6^2}=\dfrac{1}{36}}$
\question $c^{-8} = {\color{blue} \dfrac{1}{c^8}}$
\end{multicols}
\begin{multicols}{2}
\question $7^{-3} = {\color{blue} \dfrac{1}{7^3}=\dfrac{1}{343}}$
\question $p^{-5} = {\color{blue} \dfrac{1}{p^5}}$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{1}{x^{-3}} = {\color{blue} \dfrac{1}{x^3}}$
\question $\dfrac{1}{2^{-4}} = {\color{blue} 2^4=16}$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{1}{y^{-6}} = {\color{blue} y^6}$
\question $\dfrac{1}{5^{-2}} = {\color{blue} 5^2=25}$
\end{multicols}
\begin{multicols}{2}
\question $x^{-8} \cdot x^5 = {\color{blue} x^{-3}=\dfrac{1}{x^3}}$
\question $y^7 \cdot y^{-13} = {\color{blue} y^{-6}=\dfrac{1}{y^6}}$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{a^5}{a^{-2}} = {\color{blue} a^5\,a^2=a^7}$
\question $\dfrac{m^{-4}}{m^2} = {\color{blue} \dfrac{1}{m^2\,m^4}=\dfrac{1}{m^6}}$
\end{multicols}
\begin{multicols}{2}
\question $(n^{-3})^2 = {\color{blue} n^{-6}=\dfrac{1}{n^6}}$
\question $(p^2)^{-3} = {\color{blue} \dfrac{1}{(p^2)^3}=\dfrac{1}{p^6}}$
\end{multicols}
\end{questions}
...
\begin{multicols}{2}
\begin{questions}
\question $\dfrac{x^8 \cdot x^3}{x^5} = {\color{blue} \dfrac{x^{11}}{x^5}=x^{11-5}=x^6}$
\question $\dfrac{(2^3)^4}{2^7} = {\color{blue} \dfrac{2^{12}}{2^7}=2^5=32}$
\question $(y^4)^2 \cdot y^3 = {\color{blue} y^8\,y^3=y^{11}}$
\question $\dfrac{3^9}{3^5 \cdot 3^2} = {\color{blue} \dfrac{3^9}{3^7}=3^{9-7}=3^2=9}$
\question $\left(\dfrac{a^6}{a^2}\right)^3 = {\color{blue} (a^4)^3=a^{12}}$
\question $(m^2n^3)^4 = {\color{blue} m^{2\times 4}\,n^{3\times 4}=m^8\,n^{12}}$
\question $\dfrac{(x^3y^2)^2}{xy^3} = {\color{blue} \dfrac{x^6y^4}{xy^3}=x^{6-1}\,y^{4-3}=x^5\,y}$
\question $\left(\dfrac{2p^3}{q^2}\right)^3 = {\color{blue} \dfrac{2^3\,p^{3\times 3}}{q^{2\times 3}}= \dfrac{8p^9}{q^6}}$
\question $\dfrac{5^8 \cdot 5^3}{5^6} = {\color{blue} \dfrac{5^{11}}{5^6} =5^{11-6}=5^5=3,125}$
\question $(2a^2b)^3 \cdot ab^2 = {\color{blue} 2^3\,a^6\,b^3 \cdot ab^2=8\,a^7\,b^5}$
\question $\dfrac{(r^2s)^4}{r^3s^2} = {\color{blue} \dfrac{r^8s^4}{r^3s^2}=r^{8-3}\,s^{4-2}=r^5\,s^2 }$
\question $\left(\dfrac{3x^2}{y}\right)^2 \cdot \dfrac{y^3}{x} = {\color{blue} \dfrac{3^2x^4}{y^2} \cdot \dfrac{y^3}{x}=9\,x^3\,y  }$
\question $\dfrac{(m^3)^2 \cdot m^4}{m^7} = {\color{blue} \dfrac{m^6 \cdot m^4}{m^7}=\dfrac{m^{10}}{m^7}=m^3}$
\question $(4^2)^3 \cdot 4^{-5} = {\color{blue} 4^6 \cdot 4^{-5} =4^1=4}$
\question $\dfrac{(ab)^5}{a^2b^3} = {\color{blue} \dfrac{a^5b^5}{a^2b^3}=a^3\,b^2}$
\question $\left(\dfrac{x^4y}{z^2}\right)^2 \cdot z^3 = {\color{blue} \dfrac{x^8y^2}{z^4} \cdot z^3=\dfrac{x^8\,y^2}{z}}$
\question $\dfrac{6^{10}}{(6^2)^3 \cdot 6} = {\color{blue} \dfrac{6^{10}}{6^6 \cdot 6}=\dfrac{6^{10}}{6^7}=6^3=216}$
\question $(p^{-2}q^3)^2 = {\color{blue} p^{-4}q^6=\dfrac{q^6}{p^4} }$
\question $\dfrac{(2x)^4}{4x^3} = {\color{blue} \dfrac{2^4\,x^4}{4x^3}=\dfrac{16x}{4}=4\,x }$
\question $\left(\dfrac{m^2n^{-3}}{p^2}\right)^3 = {\color{blue} \dfrac{m^6\,n^{-9}}{p^6}=\dfrac{m^6}{p^6\,n^9}}$
\question $(a^3b^2)^2 \cdot (ab)^3 = {\color{blue} a^6\,b^4 \cdot a^3\,b^3=a^9\,b^7}$
\question $\dfrac{(3^4)^2}{3^5 \cdot 3^2} = {\color{blue}\dfrac{3^8}{3^7}=3 }$
\question $\left(\dfrac{x^5}{x^2}\right)^2 \cdot x^{-3} = {\color{blue} \dfrac{x^{10}}{x^4} \cdot x^{-3}=x^6\cdot x^{-3}=x^3}$
\question $(y^2z^{-1})^3 \cdot yz^4 = {\color{blue} y^6z^{-3} \cdot yz^4 =y^4\,z }$
\question $\dfrac{(5a^2)^3}{25a^4} = {\color{blue} \dfrac{5^3a^6}{5^2a^4} =5\,a^2 }$
\question $\left(\dfrac{2^3 \cdot 2^4}{2^5}\right)^2 = {\color{blue} \left(\dfrac{2^7}{2^5}\right)^2 = \left(2^2\right)^2=2^4=16}$
\question $(mn^2)^3 \cdot (m^2n)^2 = {\color{blue} m^3\,n^6 \cdot m^4\,n^2 = m^{7}\,n^8}$
\question $\dfrac{(4^2)^3 \cdot 4}{4^8} = {\color{blue} \dfrac{4^6 \cdot 4}{4^8}=\dfrac{4^7}{4^8}=\dfrac{1}{4}}$
\question $\left(\dfrac{p^3q}{r^2}\right)^2 \cdot \dfrac{r^3}{pq^2} = {\color{blue} \dfrac{p^6\,q^2}{r^4}\cdot \dfrac{r^3}{pq^2} = \dfrac{p^5}{r}}$
\question $(x^{-2}y^3)^{-2} = {\color{blue} x^4\,y^{-6}=\dfrac{x^4}{y^6}}$
\end{questions}
\end{multicols}
...
\question Simplify: $2^3 \cdot 2^4 = {\color{blue} }$

\question Simplify: $5^7 \div 5^3 = {\color{blue} }$

\end{multicols}
\begin{multicols}{2}
\question Simplify: $(3^2)^4 = {\color{blue} }$

\question Evaluate: $4^0 = {\color{blue} }$

\end{multicols}
\begin{multicols}{2}
\question Simplify: $x^5 \cdot x^3 = {\color{blue} }$

\question Simplify: $\dfrac{y^8}{y^2} = {\color{blue} }$

\end{multicols}
\begin{multicols}{2}
\question Evaluate: $2^{-3} = {\color{blue} }$

\question Simplify: $(ab)^4 = {\color{blue} }$

\end{multicols}
\begin{multicols}{2}
\question Simplify: $\left(\dfrac{x}{y}\right)^3 = {\color{blue} }$

\question Simplify: $6^1 \cdot 6^0 = {\color{blue} }$

\end{multicols}
\begin{multicols}{2}
\question Evaluate: $(-2)^4 = {\color{blue} }$

\question Simplify: $\dfrac{a^6}{a^6} = {\color{blue} }$
...
\question Simplify: $3^5 \cdot 3^{-2} \cdot 3^4 = {\color{blue} }$

\question Simplify: $\dfrac{x^7 \cdot x^3}{x^4} = {\color{blue} }$

\question Simplify: $(2x)^3 = {\color{blue} }$

\question Evaluate: $\left(\dfrac{1}{3}\right)^{-2} = {\color{blue} }$

\question Simplify: $\dfrac{(a^2)^3}{a^4} = {\color{blue} }$

\question Simplify: $(x^{-2})^4 = {\color{blue} }$

\question Simplify: $\dfrac{5^8}{5^3 \cdot 5^2} = {\color{blue} }$

\question Simplify: $(3^2 \cdot 3^{-1})^3 = {\color{blue} }$

\question Simplify: $\left(\dfrac{2a}{3b}\right)^2 = {\color{blue} }$

\question Evaluate: $8^{2/3} = {\color{blue} }$

\question Simplify: $x^{-3} \cdot x^5 \cdot x^{-1} = {\color{blue} }$

\question Simplify: $\dfrac{(2y)^4}{(2y)^2} = {\color{blue} }$
...
\question Simplify: $\dfrac{2^5 \cdot 2^{-3} \cdot 2^7}{2^4 \cdot 2^{-1}} = {\color{blue} }$

\question Simplify: $(x^2y^{-3})^4 = {\color{blue} }$

\question Simplify: $\dfrac{a^5b^{-2}}{a^{-1}b^3} = {\color{blue} }$

\question Evaluate: $27^{-2/3} = {\color{blue} }$
