...
\begin{multicols}{2}
\begin{questions}
\question $\dfrac{x^8 \cdot x^3}{x^5} = {\color{blue} }$
\question $\dfrac{(2^3)^4}{2^7} = {\color{blue} }$
\question $(y^4)^2 \cdot y^3 = {\color{blue} }$
\question $\dfrac{3^9}{3^5 \cdot 3^2} = {\color{blue} }$
\question $\left(\dfrac{a^6}{a^2}\right)^3 = {\color{blue} }$
