...
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{m^{12}}{m^7} = {\color{blue} }$
\question $\dfrac{2^{10}}{2^4} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{b^{20}}{b^{13}} = {\color{blue} }$
\question $\dfrac{6^9}{6^2} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{c^{11}}{c^8} = {\color{blue} }$
\question $\dfrac{10^7}{10^3} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{p^{18}}{p^9} = {\color{blue} }$
\question $\dfrac{4^{11}}{4^6} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{n^{25}}{n^{20}} = {\color{blue} }$
\question $\dfrac{8^9}{8^4} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{z^{16}}{z^5} = {\color{blue} }$
\question $\dfrac{9^8}{9^3} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
\question $\dfrac{w^{14}}{w^7} = {\color{blue} }$
\question $\dfrac{11^{10}}{11^6} = {\color{blue} }$
\end{multicols}
\begin{multicols}{2}
