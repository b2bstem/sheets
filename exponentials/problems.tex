...
\question $(m^2n^3)^4 = {\color{blue} }$
\question $\dfrac{(x^3y^2)^2}{xy^3} = {\color{blue} }$
\question $\left(\dfrac{2p^3}{q^2}\right)^3 = {\color{blue} }$
\question $\dfrac{5^8 \cdot 5^3}{5^6} = {\color{blue} }$
\question $(2a^2b)^3 \cdot ab^2 = {\color{blue} }$
\question $\dfrac{(r^2s)^4}{r^3s^2} = {\color{blue} }$
\question $\left(\dfrac{3x^2}{y}\right)^2 \cdot \dfrac{y^3}{x} = {\color{blue} }$
\question $\dfrac{(m^3)^2 \cdot m^4}{m^7} = {\color{blue} }$
\question $(4^2)^3 \cdot 4^{-5} = {\color{blue} }$
\question $\dfrac{(ab)^5}{a^2b^3} = {\color{blue} }$
\question $\left(\dfrac{x^4y}{z^2}\right)^2 \cdot z^3 = {\color{blue} }$
\question $\dfrac{6^{10}}{(6^2)^3 \cdot 6} = {\color{blue} }$
\question $(p^{-2}q^3)^2 = {\color{blue} }$
\question $\dfrac{(2x)^4}{4x^3} = {\color{blue} }$
\question $\left(\dfrac{m^2n^{-3}}{p^2}\right)^3 = {\color{blue} }$
\question $(a^3b^2)^2 \cdot (ab)^3 = {\color{blue} }$
\question $\dfrac{(3^4)^2}{3^5 \cdot 3^2} = {\color{blue} }$
\question $\left(\dfrac{x^5}{x^2}\right)^2 \cdot x^{-3} = {\color{blue} }$
\question $(y^2z^{-1})^3 \cdot yz^4 = {\color{blue} }$
\question $\dfrac{(5a^2)^3}{25a^4} = {\color{blue} }$
\question $\left(\dfrac{2^3 \cdot 2^4}{2^5}\right)^2 = {\color{blue} }$
\question $(mn^2)^3 \cdot (m^2n)^2 = {\color{blue} }$
\question $\dfrac{(4^2)^3 \cdot 4}{4^8} = {\color{blue} }$
\question $\left(\dfrac{p^3q}{r^2}\right)^2 \cdot \dfrac{r^3}{pq^2} = {\color{blue} }$
\question $(x^{-2}y^3)^{-2}$
\end{questions}
\end{multicols}
